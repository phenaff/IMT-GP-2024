...
Y = X \beta + E
$$
with $\textrm{Cov}(E|X) = \Omega = \sigma^2V$
...
Set $\Omega = K^TK$ and define $Z=K^{-1}Y, B=K^{-1}X, g=K^{-1}\epsilon$, the linear model becomes:
$$
Z = B\beta + g
$$
with $E(g)=0$ and $V(g)=\sigma^2I$. Applying OLS to this model yields the desired result.
