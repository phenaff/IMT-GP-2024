...
- indiquez les "prompts" que vous avez utilisé

- identifiez clairement le LLM utilisé et le code fourni par ce LLM
...
- Chargez les "packages" manquants avec
...
- Utiliser renv::install() pour ajouter des "packages".

## Verification

Vérifiez que l'installation est complète en éxécutant quelques fichiers .Rmd.
