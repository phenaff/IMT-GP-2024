...
Calculez les indicateurs de risque vega, vanna, volga pour ces trois instruments, et justifier le choix de l'instrument associé à chaque risque dans la version approximative de la méthode VV.
