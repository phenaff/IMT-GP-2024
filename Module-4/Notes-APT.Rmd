...
Soit $a = \max |w_i|, i=1, \ldots, N-K$, calculons la variance du rendement de ce portefeuille moyen:
...
$$
Si le facteur est le secteur industriel, les $\beta$ sont de la forme
\begin{align}
...
Ce modèle est également largement utilisé dans l'industrie.
...
Ici, contrairement à l'approche BARRA, les rendements des facteurs sont connus, et les $\beta$ sont estimés par regression, en utilisant les series de rendement des titres.
